...
# ATTENTION! THIS PAGE CAN NOT BE REPLACED!
...
"color: rgb(181, 131, 141);")
        ...
        self.registration_button = QtWidgets.QPushButton(self.widget_2)
        self.registration_button.setGeometry(QtCore.QRect(180, 350, 140, 40))
        self.registration_button.setStyleSheet("border-radius: 15px;\n"
"font: 14pt \"Involve\";\n"
"background-color: rgb(34, 34, 59);\n"
"color: rgb(229, 152, 155);")
...
"color: rgb(34, 34, 59);")
        ...
        self.scrollArea = QtWidgets.QScrollArea(self.welcome_page)
        ...
        self.widget_4.setGeometry(QtCore.QRect(0, 0, 1100, 1200))
        self.widget_4.setObjectName("widget_4")
        self.widget_5 = QtWidgets.QWidget(self.widget_4)
        self.widget_5.setGeometry(QtCore.QRect(175, 170, 750, 860))
        self.widget_5.setStyleSheet("border-radius: 15px;\n"
"background-color: rgb(255, 255, 255);\n"
"")
        self.widget_5.setObjectName("widget_5")
        self.anketa_word_2 = QtWidgets.QLabel(self.widget_5)
        self.anketa_word_2.setGeometry(QtCore.QRect(80, 40, 590, 50))
        self.anketa_word_2.setStyleSheet("color: rgb(34, 34, 59);\n"
"font: 24pt \"Involve\";")
        self.anketa_word_2.setAlignment(QtCore.Qt.AlignCenter)
        self.anketa_word_2.setObjectName("anketa_word_2")
        self.next_button = QtWidgets.QPushButton(self.widget_5)
...
"color: rgb(229, 152, 155);")
        ...
        self.info_label_2 = QtWidgets.QLabel(self.widget_5)
        self.info_label_2.setGeometry(QtCore.QRect(100, 70, 550, 50))
        self.info_label_2.setStyleSheet("font: 12pt \"Involve\";\n"
"color: rgb(34, 34, 59);")
        ...
        self.info_label_6 = QtWidgets.QLabel(self.widget_5)
...
"color: rgb(34, 34, 59);")
        ...
        self.info_label_7 = QtWidgets.QLabel(self.widget_5)
...
"color: rgb(34, 34, 59);")
        ...
        self.info_label_8 = QtWidgets.QLabel(self.widget_5)
...
"color: rgb(34, 34, 59);")
        ...
        self.info_label_9 = QtWidgets.QLabel(self.widget_5)
...
"color: rgb(34, 34, 59);")
        ...
        self.info_label_2.raise_()
        self.anketa_word_2.raise_()
        ...
        self.logo_5 = QtWidgets.QLabel(self.widget_4)
        self.logo_5.setGeometry(QtCore.QRect(90, 40, 240, 50))
        self.logo_5.setObjectName("logo_5")
        self.logo_icon_5 = QtWidgets.QLabel(self.widget_4)
        self.logo_icon_5.setGeometry(QtCore.QRect(40, 40, 50, 50))
        self.logo_icon_5.setObjectName("logo_icon_5")
        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        self.stacked_widget.addWidget(self.welcome_page)
        self.set_account_page = QtWidgets.QWidget()
        self.set_account_page.setObjectName("set_account_page")
        self.scrollArea_2 = QtWidgets.QScrollArea(self.set_account_page)
        self.scrollArea_2.setGeometry(QtCore.QRect(150, 270, 800, 500))
        self.scrollArea_2.setStyleSheet("border-color: rgb(255, 255, 255);\n"
"border-radius: 15px;\n"
"background-color: rgb(255, 255, 255);")
...
"background-color: rgb(255, 255, 255);")
        ...
        self.scrollArea_2.setWidget(self.scroll_widget)
        self.label_amount_accounts = QtWidgets.QLabel(self.set_account_page)
...
"color: rgb(34, 34, 59);")
        ...
        self.logo_icon_6 = QtWidgets.QLabel(self.set_account_page)
        self.logo_icon_6.setGeometry(QtCore.QRect(40, 40, 50, 50))
        self.logo_icon_6.setObjectName("logo_icon_6")
        self.save_button_setact = QtWidgets.QPushButton(self.set_account_page)
        self.save_button_setact.setGeometry(QtCore.QRect(40, 820, 140, 40))
        self.save_button_setact.setStyleSheet("border-radius: 15px;\n"
"font: 14pt \"Involve\";\n"
"background-color: rgb(34, 34, 59);\n"
"color: rgb(229, 152, 155);")
        self.save_button_setact.setObjectName("save_button_setact")
        self.error_label_setacnt = QtWidgets.QLabel(self.set_account_page)
        self.error_label_setacnt.setGeometry(QtCore.QRect(200, 810, 860, 60))
        self.error_label_setacnt.setStyleSheet("color: rgb(181, 131, 141);\n"
"font: 14pt \"Involve\";")
        self.error_label_setacnt.setText("")
        self.error_label_setacnt.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.error_label_setacnt.setWordWrap(True)
        self.error_label_setacnt.setObjectName("error_label_setacnt")
        self.create_button = QtWidgets.QPushButton(self.set_account_page)
...
"color: rgb(229, 152, 155);")
        ...
        self.amount_accounts = QtWidgets.QSpinBox(self.set_account_page)
...
"color: rgb(34, 34, 59);")
        ...
        self.logo_6 = QtWidgets.QLabel(self.set_account_page)
        self.logo_6.setGeometry(QtCore.QRect(90, 40, 240, 50))
        self.logo_6.setObjectName("logo_6")
        self.stacked_widget.addWidget(self.set_account_page)
    ...
    def retranslateUi(self, MainMenuWindow):
        ...
        self.registration_button.setText(_translate("MainMenuWindow", "Сохранить"))
        ...
        self.anketa_word_2.setText(_translate("MainMenuWindow", "<html><head/><body><p><span style=\" color:#22223b;\">Добро пожаловать в </span><span style=\" color:#22223b;\">Budget</span><span style=\" color:#e5989b;\">Keeper</span></p></body></html>"))
        self.next_button.setText(_translate("MainMenuWindow", "Вперёд"))
        self.label.setText(_translate("MainMenuWindow", "<html><head/><body><p><img src=\":/icons/icon_ok_30x30.png\"/></p></body></html>"))
        self.label_2.setText(_translate("MainMenuWindow", "<html><head/><body><p><img src=\":/icons/icon_ok_30x30.png\"/></p></body></html>"))
        self.info_label_6.setText(_translate("MainMenuWindow", "<html><head/><body><p>Смотри <span style=\" font-weight:600; color:#e5989b;\">статистику</span> и <span style=\" font-weight:600; color:#e5989b;\">движение</span> денежных средств</p></body></html>"))
        self.info_label_7.setText(_translate("MainMenuWindow", "<html><head/><body><p>Вноси <span style=\" font-weight:600; color:#e5989b;\">информацию</span> по своим счетам в конце месяца</p></body></html>"))
        self.info_label_8.setText(_translate("MainMenuWindow", "<html><head/><body><p><span style=\" color:#22223b;\">Для начала работы тебе необходимо выбрать счета, информацию </span></p><p><span style=\" color:#22223b;\">по которым ты хочешь учитывать в приложении - от 1 до 10 счетов.</span></p></body></html>"))
        self.info_label_9.setText(_translate("MainMenuWindow", "<html><head/><body><p align=\"justify\"><span style=\" color:#22223b;\">В приложении ты можешь выбрать следующие типы счетов:</span></p><p><span style=\" color:#22223b;\">- </span><span style=\" font-weight:600; color:#b5838d;\">карточный счёт</span><span style=\" color:#22223b;\"> - для отображения денежных средств на твоих картах;</span></p><p><span style=\" color:#22223b;\">- </span><span style=\" font-weight:600; color:#b5838d;\">текущий/резервный/накопительный счёт</span><span style=\" color:#22223b;\"> - для отображения денежных средств на счетах;</span></p><p><span style=\" color:#22223b;\">- </span><span style=\" font-weight:600; color:#b5838d;\">вклад</span><span style=\" color:#22223b;\"> - для отображения денежных средств, которые ты хранишь на вкладе;</span></p><p><span style=\" color:#22223b;\">- </span><span style=\" font-weight:600; color:#b5838d;\">валюта</span><span style=\" color:#22223b;\"> - для отображения денежных средств в $;</span></p><p><span style=\" color:#22223b;\">- </span><span style=\" font-weight:600; color:#b5838d;\">займ</span><span style=\" color:#22223b;\"> - для отображения денежных средств, которые ты выдал в долг.</span><br/></p><p><span style=\" color:#22223b;\">Определяйся со счетами и давай продолжим!</span></p></body></html>"))
        self.logo_5.setText(_translate("MainMenuWindow", "<html><head/><body><p><img src=\":/logo/app_name_horizontal_350x50.png\"/></p></body></html>"))
        self.logo_icon_5.setText(_translate("MainMenuWindow", "<html><head/><body><p><img src=\":/icons/logo_icon_50x50.png\"/></p></body></html>"))
        self.label_amount_accounts.setText(_translate("MainMenuWindow", "Установи количество счетов:"))
        self.logo_icon_6.setText(_translate("MainMenuWindow", "<html><head/><body><p><img src=\":/icons/logo_icon_50x50.png\"/></p></body></html>"))
        self.save_button_setact.setText(_translate("MainMenuWindow", "Сохранить"))
        self.create_button.setText(_translate("MainMenuWindow", "Создать"))
        self.logo_6.setText(_translate("MainMenuWindow", "<html><head/><body><p><img src=\":/logo/app_name_horizontal_350x50.png\"/></p></body></html>"))
